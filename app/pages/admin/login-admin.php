...
<form action="../../actions/admin/loginAdmin.php" class="form_main" method="POST">
    ...
    <input type="email" name="email" class="inputField" id="username" placeholder="Email">
    </div>
    ...
    <div class="inputContainer">
        ...
        <input type="password" name="senha" class="inputField" id="password" placeholder="Password">
    </div>
